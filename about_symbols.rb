...
class AboutSymbols < Neo::Koan
  ...
  # you are comparing object identity when comparing 2 symbols. 
  # if you want to compare CONTENT then convert to strings. 
  ...
  def test_symbols_cannot_be_concatenated
    ...
    # copied this but do not UNDERSTAND WTF is going on with NoMethodError
