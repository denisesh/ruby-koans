...
#dls stopped right HERE. 
  ...
  def test_plus_means_one_or_more
    ...
    #don't understand this one...+ plus sign matches one or more of the char that came before
    #okay i think i get it.  its looking for a match with the string provided
  end

  def test_asterisk_means_zero_or_more
    # * matches 0 or more of the things that come right before *
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    # dls...don't understand why 42 does not work here????
    assert_equal "variable_1", "variable_1"[/[a-zA-Z0-9_]+/]
...
# dls started copying and stopped thinking here..
